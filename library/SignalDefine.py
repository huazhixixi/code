...
class QamSignal(object):
    ...
    def prepare(self):
        ...
        self.ds = upsample(self.symbol, self.sps)
        self.ds = self.pulse_shaping(roll_off, span)

        self.ds_in_fiber = resampy.resample(self.ds, self.sps, self.sps_in_fiber, axis=1)
        self.set_power()
